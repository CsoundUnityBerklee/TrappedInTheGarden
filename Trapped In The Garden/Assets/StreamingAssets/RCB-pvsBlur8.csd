...
form caption("PVSblur8") size(800, 200), guiMode("queue") pluginId("def1")
...
combobox bounds(154, 150, 95, 28), channel("sound"), value(3), fontColour(220, 220, 255, 255), text("8a","8b","8c","8d","8e","8f","8g","8h","8i","8j","8k","8l")
...
kinput chnget "sound"
if kinput=1 then
aInL, aInR	diskin2 "./sounds/8a.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=2 then
aInL, aInR	diskin2 "./sounds/8b.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=3 then
aInL, aInR	diskin2 "./sounds/8c.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=4 then
aInL, aInR	diskin2 "./sounds/8d.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=5 then
aInL, aInR	diskin2 "./sounds/8e.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=6 then
aInL, aInR  diskin2 "./sounds/8f.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=7 then
aInL, aInR  diskin2 "./sounds/8g.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=8 then
aInL, aInR  diskin2 "./sounds/8h.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=9 then
aInL, aInR  diskin2 "./sounds/8i.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=10 then
aInL, aInR  diskin2 "./sounds/8j.wav", chnget:k("speed"), 0, chnget:i("loop")
elseif kinput=11 then
aInL, aInR  diskin2 "./sounds/8k.wav", chnget:k("speed"), 0, chnget:i("loop")
else
aInL, aInR	diskin2 "./sounds/8l.wav", chnget:k("speed"), 0, chnget:i("loop")
endif
