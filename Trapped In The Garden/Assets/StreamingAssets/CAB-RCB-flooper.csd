...
giSmp10  ftgen 10, 0, 0, 1, Sfile10, 0, 0, 0
...
aFloop         flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen1)), .001+(kLoopEnd * (iLen1)), 0.05, giSmp1, i(kLoopStrt) * (iLen1), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen2)), .001+(kLoopEnd * (iLen2)), 0.05, giSmp2, i(kLoopStrt) * (iLen2), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen3)), .001+(kLoopEnd * (iLen3)), 0.05, giSmp3, i(kLoopStrt) * (iLen3), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen4)), .001+(kLoopEnd * (iLen4)), 0.05, giSmp4, i(kLoopStrt) * (iLen4), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen5)), .001+(kLoopEnd * (iLen5)), 0.05, giSmp5, i(kLoopStrt) * (iLen5), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen6)), .001+(kLoopEnd * (iLen6)), 0.05, giSmp6, i(kLoopStrt) * (iLen6), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen7)), .001+(kLoopEnd * (iLen7)), 0.05, giSmp7, i(kLoopStrt) * (iLen7), int(iMode)
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen8)), .001+(kLoopEnd * (iLen8)), 0.05, giSmp8, i(kLoopStrt) * (iLen8), int(iMode)

elseif kinput=9 then
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen9)), .001+(kLoopEnd * (iLen9)), 0.05, giSmp9, i(kLoopStrt) * (iLen9), int(iMode)

elseif kinput=10 then
iLen10  filelen Sfile10
if kLoopStrt > kLoopEnd then
kLoopStrt = kLoopEnd-.1
endif
if kLoopEnd < kLoopStrt then
...
aFloop  flooper2 kGain, kPitch, .001+(kLoopStrt * (iLen10)), .001+(kLoopEnd * (iLen10)), 0.05, giSmp10, i(kLoopStrt) * (iLen10), int(iMode)
endif
