...
form caption("River Synth") size(1100, 235), pluginid("RiSyn") colour(20,25,30), guirefresh(50)
gentable          bounds(  0, 15,1100, 80), tablenumber(1), tablecolour( 55,155,255,155), tablebackgroundcolour(0,0,0,0), fill(1), alpha(0.5), outlinethickness(2), tablegridcolour(0,0,0,0), identchannel("IDRiver1"), amprange(-1.1,1.1,-1), zoom(-1), active(1)
gentable          bounds(  0, 15,1100, 80), tablenumber(2), tablecolour( 55,125,255,155), tablebackgroundcolour(0,0,0,0), fill(1), alpha(0.5), outlinethickness(2), tablegridcolour(0,0,0,0), identchannel("IDRiver2"), amprange(-1.1,1.1,-1), zoom(-1), active(1)
gentable          bounds(  0, 15,1100, 80), tablenumber(3), tablecolour( 55,125,255,155), tablebackgroundcolour(0,0,0,0), fill(1), alpha(0.5), outlinethickness(2), tablegridcolour(0,0,0,0), identchannel("IDRiver3"), amprange(-1.1,1.1,-1), zoom(-1), active(1)
image             bounds(  0, 55,1100, 80), colour( 45,45,105,155)
...
rslider    bounds(  5, 25, 70, 70), text("Level"),  channel("RoarLev"),  range(0,4,0.5,0.5),            $RSliderStyle
...
rslider    bounds(  5, 25, 70, 70), text("Level"),  channel("BurbLev"),  range(0,2,0.6,0.5),            $RSliderStyle
