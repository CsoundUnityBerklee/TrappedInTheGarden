...
rslider bounds(100, 8, 100, 100) channel("crackleGain"), text("Crackle Gain"), range(0, 1,0.5, 1, 0.001)
rslider bounds(190, 8, 100, 100) channel("hissNoise"), text("Hiss Noise"), range(0, .22, 0.04, 1, 0.001)
rslider bounds(280, 8, 100, 100) channel("flameGain"), text("Flame Gain") range(0, 1, .2, 1, 0.001)
